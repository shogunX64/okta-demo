...
const vue3_pkg_json_1 = __importDefault(require("./vue3-pkg.json"));
...
describe('OktaDev Schematics: Vue3', () => {
    ...
    it('works', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Add package.json
        tree.create('/package.json', JSON.stringify(vue3_pkg_json_1.default));
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
...
//# sourceMappingURL=vue3_spec.js.map