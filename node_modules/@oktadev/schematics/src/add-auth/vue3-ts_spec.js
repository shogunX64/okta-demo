...
const vue3_ts_pkg_json_1 = __importDefault(require("./vue3-ts-pkg.json"));
...
describe('OktaDev Schematics: Vue3 + TypeScript', () => {
    ...
    it('works', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Add package.json
        tree.create('/package.json', JSON.stringify(vue3_ts_pkg_json_1.default));
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
...
//# sourceMappingURL=vue3-ts_spec.js.map