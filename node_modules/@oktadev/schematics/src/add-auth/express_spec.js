...
const express_pkg_json_1 = __importDefault(require("./express-pkg.json"));
...
describe('OktaDev Schematics: Express', () => {
    ...
    it('works', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Add package.json
        tree.create('/package.json', JSON.stringify(express_pkg_json_1.default));
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
...
//# sourceMappingURL=express_spec.js.map